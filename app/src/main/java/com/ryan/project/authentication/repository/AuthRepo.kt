...
interface AuthRepo {
        suspend fun register(email: String, password: String): Resource<Employee>

        suspend fun login(email: String, password: String): Resource<Employee>

        suspend fun forgotPassword(email: String): Resource<Boolean>

        suspend fun changePassword(email: String, oldPassword: String, newPassword: String): Resource<Boolean>
}